...
namespace CUInventory.Migrations
{
    ...
    [Migration("20260710200533_Add_Inventory_Flow")]
    partial class Add_Inventory_Flow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CUInventory.Inventory.Aggregates.InventoryLot", b =>
                {
                    b.OwnsOne("CUInventory.ValueObjects.Quantity", "OriginalQuantity", b1 =>
                        {
                            ...
                            b1.ToTable("AppInventoryLots");

                            b1.WithOwner()
                                .HasForeignKey("InventoryLotId");
                        });

                    b.OwnsOne("CUInventory.ValueObjects.Quantity", "RemainingQuantity", b1 =>
                        {
                            b1.Property<Guid>("InventoryLotId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("CUInventory.ValueObjects.Money", "UnitCost", b1 =>
                        {
                            b1.Property<Guid>("InventoryLotId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CUInventory.Inventory.Entities.StockTransferLine", b =>
                {
                    ...
                    b.OwnsOne("CUInventory.ValueObjects.Quantity", "Quantity", b1 =>
                        {
                            b1.Property<Guid>("StockTransferLineId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("StockTransferLineId");

                            b1.ToTable("AppStockTransferLines");
            ...
            modelBuilder.Entity("CUInventory.Inventory.Entities.TransferAllocation", b =>
                {
                    ...
                    b.OwnsOne("CUInventory.ValueObjects.Quantity", "Quantity", b1 =>
                        {
                            b1.Property<Guid>("TransferAllocationId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("TransferAllocationId");

                            b1.ToTable("AppTransferAllocations");

                            b1.WithOwner()
                                .HasForeignKey("TransferAllocationId");
                        });
            ...
            modelBuilder.Entity("CUInventory.Procurement.Entities.PurchaseOrderLine", b =>
                {
                    ...
                    b.OwnsOne("CUInventory.ValueObjects.Quantity", "OrderedQuantity", b1 =>
                        {
                            ...
                            b1.ToTable("AppPurchaseOrderLines");

                            b1.WithOwner()
                                .HasForeignKey("PurchaseOrderLineId");
                        });

                    b.OwnsOne("CUInventory.ValueObjects.Quantity", "ReceivedQuantity", b1 =>
                        {
                            b1.Property<Guid>("PurchaseOrderLineId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CUInventory.Sales.Entities.SaleAllocation", b =>
                {
                    ...
                    b.OwnsOne("CUInventory.ValueObjects.Quantity", "Quantity", b1 =>
                        {
                            b1.Property<Guid>("SaleAllocationId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("SaleAllocationId");

                            b1.ToTable("AppSaleAllocations");

                            b1.WithOwner()
                                .HasForeignKey("SaleAllocationId");
                        });
                    ...
                    b.OwnsOne("CUInventory.ValueObjects.Quantity", "Quantity", b1 =>
                        {
                            ...
                            b1.ToTable("AppSaleLines");

                            b1.WithOwner()
                                .HasForeignKey("SaleLineId");
                        });

                    b.OwnsOne("CUInventory.ValueObjects.Money", "UnitPrice", b1 =>
                        {
                            b1.Property<Guid>("SaleLineId")
                                .HasColumnType("uniqueidentifier");
